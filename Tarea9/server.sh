...
sudo chown nobody:nogroup /var/nfs/prueba
sudo chmod 777 /var/nfs/prueba
...
sudo vi /etc/exports
# 6.2 Agregar la siguiente línea, guardar y salir del editor (en este caso 192.168.1.78 es la IP del cliente):
